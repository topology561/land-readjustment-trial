...
> ⛔ **K-8 §五-2（KL 裁 2026-07-31）：本文件所引之 R5 左側 146.50㎡ 已退場。**
> 該值係 `V6.dxf` 預埋圖層 `R5左側街角地最小面積`，以**舊街角規定範圍構造**繪製；
> 隨 K-8 §三〜§五 新構造之施行一併作廢，**不再作為任何驗收對拍基準**
> （新構造 R5 左 0m ＝ **225.24㎡**）。**以下為歷史文件·內文不改**。
