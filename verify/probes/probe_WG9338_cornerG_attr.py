...
# 用法：python probe_WG9338_cornerG_attr.py <repo> <SB> <out.json> <on|off>
import contextlib, io, os, sys, json, copy
import numpy as np
sys.stdout.reconfigure(encoding="utf-8")
REPO = sys.argv[1]; SB = float(sys.argv[2]); OUT = sys.argv[3]; STEP0 = sys.argv[4]
if STEP0 == "off": os.environ["WV_K6_STEP0"] = "off"
else: os.environ.pop("WV_K6_STEP0", None)
