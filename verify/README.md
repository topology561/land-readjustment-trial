...
3. **skip_col『原位次(距角序·暫行)』（僅 v1 W-D.1.2 診斷）**：W-D.2 v2 轉正
   （KL 放行 2026-07-06）tiebreaker 換源＝正典投影序 rank，該暫行欄廢止——
   v1 baseline 此欄凍結解除、不再對拍；新欄『原位次(投影序)』由 v2 段＋
   `_projection_order` 單一真相源看守。非遮真 diverge：其餘 20 欄照舊逐格。
