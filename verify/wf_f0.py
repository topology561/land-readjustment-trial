...
# W-G v3 勘誤重烤（KL 裁定 2026-07-13，前價期日勘誤 2024/01/01·per-zone）：六格逐格重算。
#   舊錨（PRE-勘誤·凍存於 baselines/PRE勘誤_期日）：0m G006 378.81/G007 375.78/G009 148.21/
#   G010 290.02/G014 131.67/G017 415.96；3.5m G007 382.54/G010 293.80/G014 133.88（其餘同 0m）。
#   G014 3.5m 133.88→133.22（KL 陳述「132.44 系」＝illustrative，機器逐格重算真值＝133.22）。
GSA_EXPECT = {
    "0m":   {"G006": 376.97, "G007": 373.85, "G009": 147.54,
             "G010": 288.47, "G014": 131.02, "G017": 413.61},
    "3.5m": {"G006": 376.97, "G007": 380.63, "G009": 147.54,
             "G010": 292.23, "G014": 133.22, "G017": 413.61},
}
# 合併後不達標之標旗轉出（KL (A) 追認）
