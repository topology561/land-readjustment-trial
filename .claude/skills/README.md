...
| `expand-contract-refactor` | 任何**寬幅重構**（去錨、改共用符號、換資料來源等血脈遍及多檔之機械性改動）動工前 |
| `fixture-provenance` | 任何**錨值轉 fixture**、或新增／搬移期望值時 |

> 後二者為**泛化波前置**（claude.ai 審 mattpocock/skills 後轉寫適配）：泛化＝去錨改造，
> 血脈遍及多檔且大量錨值要轉 fixture，二者恰為該波之施工法與驗證法。
